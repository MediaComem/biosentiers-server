...
exports.sequentially = function(knex) {
  var funcs = _.flatten(_.toArray(arguments).slice(1));
...
exports.dropTables = function(knex) {
  var tableNames = _.flatten(_.toArray(arguments).slice(1));
...
exports.dropIndices = function(knex) {
  var indexNames = _.flatten(_.toArray(arguments).slice(1));
